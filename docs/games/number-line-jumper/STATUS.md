...
2. Complete the exact-candidate owner retest and rollback evidence for the
   immutable games-site release.
3. Bind the accepted game source, release version, artifact evidence, and
   games-site promotion revision in the GAME-224 manifest.
4. Complete owner screen-reader validation before claiming final release
   acceptance.
